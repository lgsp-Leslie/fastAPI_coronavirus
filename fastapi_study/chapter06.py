...
# 当请求到来的时候，Fast API会检查请求的Authorization头信息，如果没有找到Authorization头信息，或者头信息的内容不是Bearer token，它会返回401状态码（UNAUTHORIZED）

oauth2_schema = OAuth2PasswordBearer(tokenUrl='/c06/token')  # Token的请求URL
...
fake_users_db = {
    '1': {
        'username': '1',
        'full_name': 'Harold Hua1',
        'email': 'Harold_Hua1@lgsp.com',
        'hashed_password': 'fakehashedsecret',
        'disabled': False
    },
    '2': {
        'username': '2',
        'full_name': 'Harold Hua2',
        'email': 'Harold_Hua2@lgsp.com',
...
oauth2_schema = OAuth2PasswordBearer(tokenUrl="/c06/jwt/token")
